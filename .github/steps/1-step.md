...
4. Try Mona's website locally. In the left sidebar, select **Run and Debug**, choose **Mona Astro: Dev Server**, and start the launch configuration.
   ...
   <img width=30% alt="VS Code Run and Debug" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/mona-astro-site-run-debug.png?raw=true" />
...
6. Set up the `COPILOT_GITHUB_TOKEN` repository secret that the Copilot engine will use later in the exercise.
   ...
   1. [Create a fine-grained personal access token](https://github.com/settings/personal-access-tokens/new?name=COPILOT_GITHUB_TOKEN&description=GitHub+Agentic+Workflows+-+Copilot+engine+authentication&user_copilot_requests=read) with **Copilot Requests** set to **Read**.
      <details>
        ...
        <img width="30%" alt="Fine-grained token permissions 1" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/fine-grained-token-1.png?raw=true" />
        <img width="30%" alt="Fine-grained token permissions 2" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/fine-grained-token-2.png?raw=true" />
      </details>
   ...
   5. Name the secret `COPILOT_GITHUB_TOKEN`, paste the token value, and save it.
      <details>
        ...
        <img width="30%" alt="Repository actions secrets 1" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/repo-secrets-1.png?raw=true" />
        <img width="30%" alt="Repository actions secrets 2" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/repo-secrets-2.png?raw=true" />
        <img width="30%" alt="Repository actions secrets 3" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/repo-secrets-3.png?raw=true" />
      </details>
...
7. Set the Actions workflow permissions to **Read and write permissions** so the agent can propose changes to the website content.
   ...
   <details>
     ...
     <img width="40%" alt="Actions workflow permissions 1" src="https://github.com/HPG236/skills-getting-started-with-agentic-workflows-reactor/blob/main/.github/images/actions-permissions-1.png?raw=true" />
  </details>
